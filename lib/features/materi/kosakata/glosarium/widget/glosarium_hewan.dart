...
class GlosariumHewan extends StatefulWidget {
  const GlosariumHewan({super.key});

  @override
  State<GlosariumHewan> createState() => _GlosariumHewanState();
}

class _GlosariumHewanState extends State<GlosariumHewan> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.network(
      '${AppAssets.github_link}/video_materi/HEWAN_TERNAK.mp4',
                  ...
                  return GestureDetector(
                    onTap: () async {
                      await firestore
                          ...
                          .doc(auth.currentUser!.uid)
                          .update({
                        'last_click': MateriHewanTernak.listMateriHewanTernak[0]
                            ['materi_list'][index]['title']
                      });

                      player.play(AssetSource(
                          MateriHewanTernak.listMateriHewanTernak[0]
