...
class GlosariumBenda extends StatefulWidget {
  const GlosariumBenda({super.key});

  @override
  State<GlosariumBenda> createState() => _GlosariumBendaState();
}

class _GlosariumBendaState extends State<GlosariumBenda> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.network(
      '${AppAssets.github_link}/video_materi/KATA_BENDA.mp4',
                  ...
                  return GestureDetector(
                    onTap: () async {
                      await firestore
                          ...
                          .doc(auth.currentUser!.uid)
                          .update({
                        'last_click': MateriKataBenda.listMateriKataBenda[0]
                            ['materi_list'][index]['title']
                      });

                      player.play(AssetSource(
                          MateriKataBenda.listMateriKataBenda[0]['materi_list']
                              [index]["audio"]));
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(
                              int.parse(
                                MateriKataBenda.listMateriKataBenda[0]
