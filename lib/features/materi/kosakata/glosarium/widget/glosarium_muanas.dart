...
class GlosariumMuannas extends StatefulWidget {
  const GlosariumMuannas({super.key});

  @override
  State<GlosariumMuannas> createState() => _GlosariumMuannasState();
}

class _GlosariumMuannasState extends State<GlosariumMuannas> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.network(
      '${AppAssets.github_link}/video_materi/MUANNAS_MUDZAKKAR.mp4',
                      ...
                      return GestureDetector(
                        onTap: () async {
                          await firestore
                              ...
                              .doc(auth.currentUser!.uid)
                              .update({
                            'last_click': MateriMuannasMudzakkar
                                    .listMateriMuannasMudzakkar[0]
                                ['materi_list'][index]['title']
                          });

                          player.play(AssetSource(MateriMuannasMudzakkar
                                  .listMateriMuannasMudzakkar[0]['materi_list']
                              [index]["audio"]));
                        ...
                        child: Stack(
                          children: <Widget>[
                            ...
                            Positioned(
                              ...
                              child: Icon(
                                Icons.star,
                                color: snapshot.data!.docs[index + 4]
                                            ['status'] ==
                                        true
                                    ? Colors.yellow
                                    : Colors.white,
